...
const IdentificationUpdateScreen = (props) => {
        ...
        switch (type) {
            case 'font':
                setIdentificationInformation({
                    ...
                    image_font:imagePick
                });
                return;
            case 'back':
                setIdentificationInformation({
                    ...identificationInformation,
                    image_back:imagePick
                });
                return;
            case 'portrait':
                setIdentificationInformation({
                    ...identificationInformation,
                    image_portrait:imagePick
                });
                return;
        }
    ...
    const _onNextSection = () => {
        ...
        let images_data = Object.values(identificationInformation);
    ...
    React.useLayoutEffect(() => {
        ...
        if (candidateInformation.images) {
            setIdentificationInformation(candidateInformation.images);
        }
            ...
            <ScrollView>
                ...
                <View>
                    <View style={[styles.row, { alignItems: 'center', justifyContent: 'center', marginHorizontal: 22 }]}>
                        ...
                        <Image
                            source={{
                                uri: identificationInformation.image_font?.path || CommonImages.notFound
                            }}
                    ...
                    <View style={[styles.row, { alignItems: 'center', justifyContent: 'center', marginHorizontal: 22 }]}>
                        <Image
                            source={{
                                uri: identificationInformation.image_back?.path || CommonImages.notFound
                            }}
                            style={{
                                width: deviceWidth / 2,
                                height: 120,
                    ...
                    <View style={[styles.row, { alignItems: 'center', justifyContent: 'center', marginHorizontal: 22 }]}>
                        <Image
                            source={{
                                uri: identificationInformation.image_portrait?.path || CommonImages.notFound
                            }}
                            style={{
                                width: deviceWidth / 2,
                                height: 220,
